    ...
    whatsnew: {
        ...
        html: `
            ...
            <div class="ytd-changelog-entry">
                <span class="ytd-changelog-version">v2.3.2</span><span class="ytd-changelog-date">— Refined PWA icons</span>
                <ul>
                    <li><b>🎨 New icon design</b> — clipboard glyph with depth (drop shadow, paper highlight, gradient metal clip), crisp accent-blue done indicator with white tick, soft halo around the bottom-right accent dot</li>
                    <li>Background changed from flat black to a subtle vertical gradient (<code>#1a2332 → #0a0e14</code>)</li>
                    <li>Maskable icons strictly honour Android's 80% safe zone</li>
                    <li>Favicon downsampled from 192px (was previously redrawn at 32px) so it stays sharp in browser tabs</li>
                </ul>
            </div>
